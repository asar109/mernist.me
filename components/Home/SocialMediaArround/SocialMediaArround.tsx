      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/mernist-nothing/"} />
            {/* Instagram Icon */}
            {/* <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/xredme/"} /> */}
            {/* Youtube Icon */}
            <IconClickableWithAnimation Icon={YoutubeIcon} href={"https://www.youtube.com/@mernist_nothing"} />
          </div>
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:mernist@nothing.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-secondary hover:cursor-pointer">
                mernist<span className="text-secondary">@</span>nothing<span className="text-secondary">.</span>com
              </span>
            </a>
          </motion.div>
