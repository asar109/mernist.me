    ...
    <>
      <section className=" w-full h-full flex flex-row sm:space-x-12 space-x-4 justify-center items-center pb-16">
        ...
        <motion.div
          ...
          className="flex flex-col items-center text-gray-400 hover:text-secondary duration-300"
        >
        ...
        >
          ...
          <span className="sm:text-lg text-sm font-mono text-gray-400 group-hover:text-secondary duration-200 group-hover:translate-x-2">
            Restart
          </span>
        </motion.div>
      </section>
