        ...
        >
          ...
          <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
            <p className="text-gray-300 md:text-gray-400 text-left">
              ...
              The product page showcases animated tabs for different products,
              blending aesthetics with functionality seamlessly. Lastly, the
              contact page offers a beautifully designed form for effortless
              communication.Additionally
              <span className="text-secondary"> Tawk.to</span> is integrated for
              live chat
            </p>
          </div>
          <ul
