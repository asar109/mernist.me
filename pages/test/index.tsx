    ...
    >
      ...
      >
        <motion.div
          ...
          className="absolute h-2 w-12 bg-secondary rounded "
        ></motion.div>
        <motion.div
          initial={{ scale: 0, x: 0 }}
          animate={{ scale: 1, rotate: 90, x: -36 }}
        ...
        <motion.div
          initial={{ opacity: 0, scale: 0, x: 0, y: 0 }}
          animate={{ opacity: 1, scale: 1.05, rotate: -33, x: 18, y: 32 }}
          transition={{
            opacity: { delay: 2, duration: 0 },
            scale: { duration: 2.5 },
            rotate: { delay: 0.5, duration: 0.5 },
        ...
        <motion.span
          ...
          className={`text-secondary  flex justify-center items-center font-Text2 text-4xl ${font.className} `}
        >
          M
        </motion.span>
      </motion.div>
