    ...
    absolute md:grid grid-cols-12 w-full h-full  content-center"
      >
        <div className="relative rounded-md w-full h-full col-span-7 ">
          <a href="https://mernist.live/" target={"_blank"} rel="noreferrer">
            <div
        ...
        >
          ...
          <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
            ...
            <p className="text-gray-300 md:text-gray-400 text-left ">
              ...
              for continuous functionality. This project highlights my expertise
              in building interactive web applications focused on user
              experience and real-time communication.{" "}
            </p>
          </div>
          <ul
         ...
         text-sm font-Text2 md:justify-end"
          ...
          <div className="z-10 flex fle-row space-x-5 ">
            ...
            <a href="http://mernist.live/" target={"_blank"} rel="noreferrer">
