        ...
        >
          ...
          <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
            <p className="text-gray-300 md:text-gray-400 text-left">
              This landing page showcases a mobile app, featuring live download
              counts and review statistics sourced from the Play Store. The
              website includes sections highlighting the app&apos;s{" "}
              ...
              Developed using HTML, CSS, and JavaScript, it offers an immersive
              experience for users exploring the app&apos;s offerings.
            </p>
          </div>
          <ul
