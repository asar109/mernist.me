...
export default function Maintenance() {
  return (
    <div className="relative snap-mandatory min-h-screen bg-primary w-full flex justify-center items-center">
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
          ...
          <p className="font-light text-white-500 md:text-lg xl:text-xl dark:text-gray-400">
            ...
            <a
              ...
              href="mailto:mernist@nothing.com?subject=Hello%20World&body=Body%20of%20the%20email"
            >
              mernist@nothing.com
            </a>
          </p>
