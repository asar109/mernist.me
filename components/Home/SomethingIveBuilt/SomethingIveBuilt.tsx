  ...
  return (
    ...
    >
      ...
      <div data-aos="fade-up" className=" flex flex-row  items-center md:px-0">
        <ArrowIcon className={"flex-none h-5 md:h-6 w-5 md:w-5 translate-y-[2px] text-secondary"} />
        <div className="flex-none flex-row space-x-2 items-center pr-2">
          <span className="text-secondary font-sans text-sm  sm:text-xl"> 03.</span>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-secondary text-base">ENS Vision </span>
              ...
              <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  At <span className="text-secondary">ENS Vision</span>, I played a crucial role in developing web3
                  components for their <span className="text-secondary">web3 application</span> using Next.js and web3
                  libraries. Our focus was on integrating new features and improving the user interface. One notable
                  achievement was the release of NameWrapper with <span className="text-secondary">ERC72</span>{" "}
                  support, enabling users to create <span className="text-secondary">subdomains</span>. This showcased
            ...
            >
              ...
              <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  ...
                  project, including the <span className="text-secondary"> design</span> and implementation of the{" "}
                  <span className="text-secondary"> smart contract</span> and{" "}
                  <span className="text-secondary"> blockchain technology</span>. Here i share with you{" "}
                  <span className="text-secondary"> YPredict - v1 </span> for the private sale.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  This project aim to help you to improve your <span className="text-secondary"> typing </span> by
                  tracking your progress in <span className="text-secondary"> each round</span> and give you a{" "}
                  <span className="text-secondary"> score</span> based on your typing speed and accuracy through a
                  table of <span className="text-secondary"> statistics</span>.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
            ...
            >
              ...
              <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  ...
                  <span className="text-secondary">{","} software, Hardware</span> and some additional information
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96">
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full   rounded  ml-4 mt-2  text-end pr-8">
              ...
              <span className="text-secondary sm:text-lg bg-primary px-2 py-1 rounded">In initiation...</span>
            </div>
            <div
              className="px-8 pt-8 sm:pt-12 md:py-0 xl:col-span-6 xl:col-start-7 col-start-5 
            ...
            >
              ...
              <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  It&apos; a barber shop <span className="text-secondary">appointment scheduling</span> & management
                  software it provides <span className="text-secondary">online scheduling</span>, appointment
                  reminders, <span className="text-secondary">payments</span>, marketing, and much more! Currently in
                  the <span className="text-secondary">Initiation phase</span>.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="w-full md:bg-tertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  A <span className="text-secondary">JavaFX call center management system</span> project it is used
